...
public class LobCreeperSpell
extends AbstractSpell {
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath((String)"irons_spellbooks", (String)"lob_creeper");
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        float speed = (float)(10 + spellLevel) * 0.08f;
        ...
        head.moveTo(spawn.x, spawn.y - head.getBoundingBox().getYsize() / 2.0, spawn.z, entity.getYRot() + 180.0f, entity.getXRot());
