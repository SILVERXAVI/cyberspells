...
public class ItemRegistry {
    private static final DeferredRegister<Item> ITEMS = DeferredRegister.create((ResourceKey)Registries.ITEM, (String)"irons_spellbooks");
    ...
    public static final DeferredHolder<Item, Item> NETHERITE_SPELL_BOOK = ITEMS.register("netherite_spell_book", () -> new SpellBook(12).withSpellbookAttributes(new AttributeContainer((Holder<Attribute>)AttributeRegistry.COOLDOWN_REDUCTION, 0.2, AttributeModifier.Operation.ADD_MULTIPLIED_BASE), new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 200.0, AttributeModifier.Operation.ADD_VALUE)));
    public static final DeferredHolder<Item, Item> DIAMOND_SPELL_BOOK = ITEMS.register("diamond_spell_book", () -> new SpellBook(10).withSpellbookAttributes(new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 100.0, AttributeModifier.Operation.ADD_VALUE)));
    public static final DeferredHolder<Item, Item> GOLD_SPELL_BOOK = ITEMS.register("gold_spell_book", () -> new SpellBook(8).withSpellbookAttributes(new AttributeContainer((Holder<Attribute>)AttributeRegistry.CAST_TIME_REDUCTION, 0.15, AttributeModifier.Operation.ADD_MULTIPLIED_BASE), new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 50.0, AttributeModifier.Operation.ADD_VALUE)));
    ...
    public static final DeferredHolder<Item, Item> ROTTEN_SPELL_BOOK = ITEMS.register("rotten_spell_book", () -> new SpellBook(8).withSpellbookAttributes(new AttributeContainer((Holder<Attribute>)AttributeRegistry.SPELL_RESIST, -0.15, AttributeModifier.Operation.ADD_MULTIPLIED_BASE), new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 100.0, AttributeModifier.Operation.ADD_VALUE)));
    public static final DeferredHolder<Item, Item> BLAZE_SPELL_BOOK = ITEMS.register("blaze_spell_book", () -> new SpellBook(10).withSpellbookAttributes(new AttributeContainer((Holder<Attribute>)AttributeRegistry.FIRE_SPELL_POWER, 0.1, AttributeModifier.Operation.ADD_MULTIPLIED_BASE), new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 200.0, AttributeModifier.Operation.ADD_VALUE)));
    public static final DeferredHolder<Item, Item> DRAGONSKIN_SPELL_BOOK = ITEMS.register("dragonskin_spell_book", () -> new SpellBook(12).withSpellbookAttributes(new AttributeContainer((Holder<Attribute>)AttributeRegistry.ENDER_SPELL_POWER, 0.1, AttributeModifier.Operation.ADD_MULTIPLIED_BASE), new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 200.0, AttributeModifier.Operation.ADD_VALUE)));
    public static final DeferredHolder<Item, Item> DRUIDIC_SPELL_BOOK = ITEMS.register("druidic_spell_book", () -> new SpellBook(10).withSpellbookAttributes(new AttributeContainer((Holder<Attribute>)AttributeRegistry.NATURE_SPELL_POWER, 0.1, AttributeModifier.Operation.ADD_MULTIPLIED_BASE), new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 200.0, AttributeModifier.Operation.ADD_VALUE)));
    public static final DeferredHolder<Item, Item> VILLAGER_SPELL_BOOK = ITEMS.register("villager_spell_book", () -> new SpellBook(10).withSpellbookAttributes(new AttributeContainer((Holder<Attribute>)AttributeRegistry.HOLY_SPELL_POWER, 0.1, AttributeModifier.Operation.ADD_MULTIPLIED_BASE), new AttributeContainer((Holder<Attribute>)AttributeRegistry.CAST_TIME_REDUCTION, 0.1, AttributeModifier.Operation.ADD_MULTIPLIED_BASE), new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 200.0, AttributeModifier.Operation.ADD_VALUE)));
    public static final DeferredHolder<Item, Item> ICE_SPELL_BOOK = ITEMS.register("ice_spell_book", () -> new SpellBook(12).withSpellbookAttributes(new AttributeContainer((Holder<Attribute>)AttributeRegistry.ICE_SPELL_POWER, 0.1, AttributeModifier.Operation.ADD_MULTIPLIED_BASE), new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 200.0, AttributeModifier.Operation.ADD_VALUE)));
    ...
    public static final DeferredHolder<Item, Item> PYRIUM_STAFF = ITEMS.register("pyrium_staff", () -> new PyriumStaffItem(ItemPropertiesHelper.equipment(1).attributes(ExtendedSwordItem.createAttributes(StaffTier.PYRIUM_STAFF)).rarity((Rarity)CinderousRarity.CINDEROUS_RARITY_PROXY.getValue()).fireResistant()));
    ...
    public static final DeferredHolder<Item, Item> EVOKER_SPELL_BOOK = ITEMS.register("evoker_spell_book", () -> new UniqueSpellBook(new SpellDataRegistryHolder[]{new SpellDataRegistryHolder(SpellRegistry.FANG_STRIKE_SPELL, 6), new SpellDataRegistryHolder(SpellRegistry.FANG_WARD_SPELL, 4), new SpellDataRegistryHolder(SpellRegistry.SUMMON_VEX_SPELL, 4)}, 7).withSpellbookAttributes(new AttributeContainer((Holder<Attribute>)AttributeRegistry.EVOCATION_SPELL_POWER, 0.1, AttributeModifier.Operation.ADD_MULTIPLIED_BASE), new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 200.0, AttributeModifier.Operation.ADD_VALUE)));
    ...
    public static final DeferredHolder<Item, Item> LEGIONNAIRE_FLAMBERGE = ITEMS.register("legionnaire_flamberge", () -> new ExtendedSwordItem(ExtendedWeaponTier.LEGIONNAIRE_FLAMBERGE, ItemPropertiesHelper.equipment().rarity((Rarity)CinderousRarity.CINDEROUS_RARITY_PROXY.getValue()).fireResistant().attributes(ExtendedSwordItem.createAttributes(ExtendedWeaponTier.LEGIONNAIRE_FLAMBERGE))));
    ...
    public static final DeferredHolder<Item, Item> HELLRAZOR = ITEMS.register("hellrazor", () -> new MagicSwordItem(ExtendedWeaponTier.HELLRAZOR, ItemPropertiesHelper.equipment().attributes(ExtendedSwordItem.createAttributes(ExtendedWeaponTier.HELLRAZOR)).rarity((Rarity)CinderousRarity.CINDEROUS_RARITY_PROXY.getValue()).fireResistant(), SpellDataRegistryHolder.of(new SpellDataRegistryHolder(SpellRegistry.RAISE_HELL_SPELL, 3))));
    ...
    public static final DeferredHolder<Item, Item> ICE_GREATSWORD = ITEMS.register("boreal_blade", () -> new MagicSwordItem(ExtendedWeaponTier.ICE_GREATSWORD, ItemPropertiesHelper.equipment().attributes(ExtendedSwordItem.createAttributes(ExtendedWeaponTier.ICE_GREATSWORD)).rarity(Rarity.RARE).fireResistant(), SpellDataRegistryHolder.of(new SpellDataRegistryHolder(SpellRegistry.FROSTBITE_SPELL, 3))));
    public static final DeferredHolder<Item, Item> TWILIGHT_GALE = ITEMS.register("twilight_gale", () -> new TwilightGaleItem(ExtendedWeaponTier.TWILIGHT_GALE, ItemPropertiesHelper.equipment().attributes(ExtendedSwordItem.createAttributes(ExtendedWeaponTier.TWILIGHT_GALE)).rarity(Rarity.RARE).fireResistant(), SpellDataRegistryHolder.of(new SpellDataRegistryHolder(SpellRegistry.VOLT_STRIKE_SPELL, 5))));
    public static final DeferredHolder<Item, Item> INK_COMMON = ITEMS.register("common_ink", () -> new InkItem(SpellRarity.COMMON, (Holder<Fluid>)FluidRegistry.COMMON_INK));
    public static final DeferredHolder<Item, Item> INK_UNCOMMON = ITEMS.register("uncommon_ink", () -> new InkItem(SpellRarity.UNCOMMON, (Holder<Fluid>)FluidRegistry.UNCOMMON_INK));
    public static final DeferredHolder<Item, Item> INK_RARE = ITEMS.register("rare_ink", () -> new InkItem(SpellRarity.RARE, (Holder<Fluid>)FluidRegistry.RARE_INK));
    public static final DeferredHolder<Item, Item> INK_EPIC = ITEMS.register("epic_ink", () -> new InkItem(SpellRarity.EPIC, (Holder<Fluid>)FluidRegistry.EPIC_INK));
    public static final DeferredHolder<Item, Item> INK_LEGENDARY = ITEMS.register("legendary_ink", () -> new InkItem(SpellRarity.LEGENDARY, (Holder<Fluid>)FluidRegistry.LEGENDARY_INK));
    ...
    public static final DeferredHolder<Item, Item> INVISIBILITY_ELIXIR = ITEMS.register("invisibility_elixir", () -> new SimpleElixir(ItemPropertiesHelper.material(4), () -> new MobEffectInstance(MobEffectRegistry.TRUE_INVISIBILITY, 300, 0, false, false, true)));
    public static final DeferredHolder<Item, Item> GREATER_INVISIBILITY_ELIXIR = ITEMS.register("greater_invisibility_elixir", () -> new SimpleElixir(ItemPropertiesHelper.material(4), () -> new MobEffectInstance(MobEffectRegistry.TRUE_INVISIBILITY, 800, 0, false, false, true), true));
    public static final DeferredHolder<Item, Item> EVASION_ELIXIR = ITEMS.register("evasion_elixir", () -> new SimpleElixir(ItemPropertiesHelper.material(4), () -> new MobEffectInstance(MobEffectRegistry.EVASION, 1200, 1, false, false, true)));
    public static final DeferredHolder<Item, Item> GREATER_EVASION_ELIXIR = ITEMS.register("greater_evasion_elixir", () -> new SimpleElixir(ItemPropertiesHelper.material(4), () -> new MobEffectInstance(MobEffectRegistry.EVASION, 1200, 3, false, false, true), true));
    ...
    public static final DeferredHolder<Item, Item> CITADEL_FURLED_MAP = ITEMS.register("furled_map_citadel", () -> new FurledMapCraftableItem(true, new FurledMapItem.FurledMapData(IronsSpellbooks.id("citadel"), Optional.of(FurledMapItem.NETHER), Optional.of(Component.translatable((String)"item.irons_spellbooks.furled_map_descriptor_framing", (Object[])new Object[]{Component.translatable((String)"item.irons_spellbooks.citadel_map")}).setStyle(Style.EMPTY.withColor(ChatFormatting.GOLD))))));
    public static final DeferredHolder<Item, Item> ICE_SPIDER_FURLED_MAP = ITEMS.register("furled_map_ice_spider_den", () -> new FurledMapCraftableItem(false, new FurledMapItem.FurledMapData(IronsSpellbooks.id("ice_spider_den"), Optional.of(FurledMapItem.OVERWORLD), Optional.of(Component.translatable((String)"item.irons_spellbooks.furled_map_descriptor_framing", (Object[])new Object[]{Component.translatable((String)"item.irons_spellbooks.ice_spider_den_map")}).setStyle(Style.EMPTY.withColor(ChatFormatting.GOLD))))));
    ...
    public static final DeferredHolder<Item, Item> PYRIUM_INGOT = ITEMS.register("pyrium_ingot", () -> new Item(ItemPropertiesHelper.material().rarity((Rarity)CinderousRarity.CINDEROUS_RARITY_PROXY.getValue()).fireResistant()));
    ...
    public static final DeferredHolder<Item, Item> MITHRIL_INGOT = ITEMS.register("mithril_ingot", () -> new Item(ItemPropertiesHelper.material().rarity(Rarity.RARE)));
    public static final DeferredHolder<Item, Item> MITHRIL_WEAVE = ITEMS.register("mithril_weave", () -> new Item(ItemPropertiesHelper.material().rarity(Rarity.RARE)));
    public static final DeferredHolder<Item, Item> WEAPON_PARTS = ITEMS.register("weapon_parts", () -> new Item(ItemPropertiesHelper.material().rarity(Rarity.RARE)));
    public static final DeferredHolder<Item, Item> DIVINE_SOULSHARD = ITEMS.register("divine_soulshard", () -> new Item(ItemPropertiesHelper.material().rarity(Rarity.EPIC).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, (Object)true).fireResistant()));
    public static final DeferredHolder<Item, Item> TRANSLATED_ARCHEVOKER_LOGBOOK = ITEMS.register("archevoker_logbook_translated", () -> new ArchevokerLogbookItem(true, new Item.Properties().component(DataComponents.WRITTEN_BOOK_CONTENT, (Object)ArchevokerLogbookItem.TRANSLATED_CONTENTS)));
    public static final DeferredHolder<Item, Item> UNTRANSLATED_ARCHEVOKER_LOGBOOK = ITEMS.register("archevoker_logbook_untranslated", () -> new ArchevokerLogbookItem(false, new Item.Properties().component(DataComponents.WRITTEN_BOOK_CONTENT, (Object)ArchevokerLogbookItem.UNTRANSLATED_CONTENTS)));
    ...
    public static final DeferredHolder<Item, Item> CINDEROUS_SOULCALLER = ITEMS.register("cinderous_soulcaller", () -> new CinderousSoulcallerItem(ItemPropertiesHelper.material(1).rarity((Rarity)CinderousRarity.CINDEROUS_RARITY_PROXY.getValue()).fireResistant()));
    ...
    public static final DeferredHolder<Item, Item> INSCRIPTION_TABLE_BLOCK_ITEM = ITEMS.register("inscription_table", () -> new BlockItem((Block)BlockRegistry.INSCRIPTION_TABLE_BLOCK.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> ACANE_ANVIL_BLOCK_ITEM = ITEMS.register("arcane_anvil", () -> new BlockItem((Block)BlockRegistry.ARCANE_ANVIL_BLOCK.get(), new Item.Properties().rarity(Rarity.EPIC)));
    public static final DeferredHolder<Item, Item> SCROLL_FORGE_BLOCK = ITEMS.register("scroll_forge", () -> new BlockItem((Block)BlockRegistry.SCROLL_FORGE_BLOCK.get(), new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final DeferredHolder<Item, Item> PEDESTAL_BLOCK_ITEM = ITEMS.register("pedestal", () -> new BlockItem((Block)BlockRegistry.PEDESTAL_BLOCK.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> ARMOR_PILE_BLOCK_ITEM = ITEMS.register("armor_pile", () -> new BlockItem((Block)BlockRegistry.ARMOR_PILE_BLOCK.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> MITHRIL_ORE_BLOCK_ITEM = ITEMS.register("mithril_ore", () -> new BlockItem((Block)BlockRegistry.MITHRIL_ORE.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> MITHRIL_ORE_DEEPSLATE_BLOCK_ITEM = ITEMS.register("deepslate_mithril_ore", () -> new BlockItem((Block)BlockRegistry.MITHRIL_ORE_DEEPSLATE.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> ALCHEMIST_CAULDRON_BLOCK_ITEM = ITEMS.register("alchemist_cauldron", () -> new BlockItem((Block)BlockRegistry.ALCHEMIST_CAULDRON.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> FIREFLY_JAR_ITEM = ITEMS.register("firefly_jar", () -> new BlockItem((Block)BlockRegistry.FIREFLY_JAR.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> PORTAL_FRAME_ITEM = ITEMS.register("portal_frame", PortalFrameBlockItem::new);
    public static final DeferredHolder<Item, Item> BRAZIER_ITEM = ITEMS.register("brazier", () -> new BlockItem((Block)BlockRegistry.BRAZIER_FIRE.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> SOUL_BRAZIER_ITEM = ITEMS.register("brazier_soul", () -> new BlockItem((Block)BlockRegistry.BRAZIER_SOUL.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> CINDEROUS_KEYSTONE_BLOCK_ITEM = ITEMS.register("cinderous_soul_rune", () -> new BlockItem((Block)BlockRegistry.CINDEROUS_KEYSTONE.get(), new Item.Properties().rarity((Rarity)CinderousRarity.CINDEROUS_RARITY_PROXY.getValue())));
    public static final DeferredHolder<Item, Item> ICE_SPIDER_EGG_BLOCK_ITEM = ITEMS.register("ice_spider_egg", () -> new BlockItem((Block)BlockRegistry.ICE_SPIDER_EGG.get(), new Item.Properties().rarity(Rarity.RARE)));
    public static final DeferredHolder<Item, Item> BOOK_STACK_BLOCK_ITEM = ITEMS.register("book_stack", () -> new SimpleDescriptiveBlockItem((Block)BlockRegistry.BOOK_STACK.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> WISEWOOD_BOOKSHELF_BLOCK_ITEM = ITEMS.register("wisewood_bookshelf", () -> new BlockItem((Block)BlockRegistry.WISEWOOD_BOOKSHELF.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> WISEWOOD_CHISELED_BOOKSHELF_BLOCK_ITEM = ITEMS.register("wisewood_chiseled_bookshelf", () -> new BlockItem((Block)BlockRegistry.WISEWOOD_CHISELLED_BOOKSHELF.get(), new Item.Properties()));
    public static final DeferredHolder<Item, Item> NETHER_BRICK_PILLAR_BLOCK_ITEM = ITEMS.register("nether_brick_pillar", () -> new BlockItem((Block)BlockRegistry.NETHER_BRICK_PILLAR.get(), new Item.Properties()));
    ...
    public static final DeferredHolder<Item, Item> WIZARD_HAT = ITEMS.register("wizard_hat", () -> new WizardArmorItem(ArmorItem.Type.HELMET, ItemPropertiesHelper.equipment(1).durability(ArmorItem.Type.HELMET.getDurability(37)).component(ComponentRegistry.CLOTHING_VARIANT, (Object)"hat")));
    ...
    public static final Supplier<CurioBaseItem> MANA_RING = ITEMS.register("mana_ring", () -> new CurioBaseItem(ItemPropertiesHelper.equipment(1)).withAttributes(Curios.RING_SLOT, new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 100.0, AttributeModifier.Operation.ADD_VALUE)));
    public static final Supplier<CurioBaseItem> SILVER_RING = ITEMS.register("silver_ring", () -> new CurioBaseItem(ItemPropertiesHelper.equipment(1)).withAttributes(Curios.RING_SLOT, new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 25.0, AttributeModifier.Operation.ADD_VALUE)));
    public static final Supplier<CurioBaseItem> COOLDOWN_RING = ITEMS.register("cooldown_ring", () -> new CurioBaseItem(ItemPropertiesHelper.equipment(1)).withAttributes(Curios.RING_SLOT, new AttributeContainer((Holder<Attribute>)AttributeRegistry.COOLDOWN_REDUCTION, 0.15, AttributeModifier.Operation.ADD_MULTIPLIED_BASE)));
    public static final Supplier<CurioBaseItem> CAST_TIME_RING = ITEMS.register("cast_time_ring", () -> new CurioBaseItem(ItemPropertiesHelper.equipment(1)).withAttributes(Curios.RING_SLOT, new AttributeContainer((Holder<Attribute>)AttributeRegistry.CAST_TIME_REDUCTION, 0.15, AttributeModifier.Operation.ADD_MULTIPLIED_BASE)));
    public static final Supplier<CurioBaseItem> HEAVY_CHAIN = ITEMS.register("heavy_chain_necklace", () -> new CurioBaseItem(ItemPropertiesHelper.equipment(1)).withAttributes(Curios.NECKLACE_SLOT, new AttributeContainer((Holder<Attribute>)AttributeRegistry.SPELL_RESIST, 0.15, AttributeModifier.Operation.ADD_MULTIPLIED_BASE)));
    ...
    public static final Supplier<CurioBaseItem> CONJURERS_TALISMAN = ITEMS.register("conjurers_talisman", () -> new CurioBaseItem(ItemPropertiesHelper.equipment(1)).withAttributes(Curios.NECKLACE_SLOT, new AttributeContainer((Holder<Attribute>)AttributeRegistry.SUMMON_DAMAGE, 0.15, AttributeModifier.Operation.ADD_MULTIPLIED_BASE)));
    public static final Supplier<CurioBaseItem> GREATER_CONJURERS_TALISMAN = ITEMS.register("greater_conjurers_talisman", () -> new SimpleDescriptiveCurio(ItemPropertiesHelper.equipment(1)).withAttributes(Curios.NECKLACE_SLOT, new AttributeContainer((Holder<Attribute>)AttributeRegistry.SUMMON_DAMAGE, 0.15, AttributeModifier.Operation.ADD_MULTIPLIED_BASE)));
    ...
    public static final Supplier<CurioBaseItem> SIGNET_OF_THE_BETRAYER = ITEMS.register("betrayer_signet", () -> new BetrayerSignetRingItem().withAttributes(Curios.RING_SLOT, new AttributeContainer((Holder<Attribute>)AttributeRegistry.ELDRITCH_SPELL_POWER, 0.1, AttributeModifier.Operation.ADD_MULTIPLIED_BASE)));
    public static final DeferredHolder<Item, Item> MUSIC_DISC_DEAD_KING_LULLABY = ITEMS.register("music_disc_dead_king_lullaby", () -> new Item(ItemPropertiesHelper.material(1).rarity(Rarity.RARE).jukeboxPlayable(ResourceKey.create((ResourceKey)Registries.JUKEBOX_SONG, (ResourceLocation)IronsSpellbooks.id("dead_king_lullaby")))));
    public static final DeferredHolder<Item, Item> MUSIC_DISC_FLAME_STILL_BURNS = ITEMS.register("music_disc_flame_still_burns", () -> new Item(ItemPropertiesHelper.material(1).rarity((Rarity)CinderousRarity.CINDEROUS_RARITY_PROXY.getValue()).jukeboxPlayable(ResourceKey.create((ResourceKey)Registries.JUKEBOX_SONG, (ResourceLocation)IronsSpellbooks.id("flame_still_burns")))));
    public static final DeferredHolder<Item, Item> FLAME_STILL_BURNS_FRAGMENT = ITEMS.register("disc_fragment_flame_still_burns", () -> new DiscFragmentItem(ItemPropertiesHelper.material().rarity((Rarity)CinderousRarity.CINDEROUS_RARITY_PROXY.getValue())));
    public static final DeferredHolder<Item, Item> MUSIC_DISC_WHISPERS_OF_ICE = ITEMS.register("music_disc_whispers_of_ice", () -> new Item(ItemPropertiesHelper.material(1).rarity(Rarity.RARE).jukeboxPlayable(ResourceKey.create((ResourceKey)Registries.JUKEBOX_SONG, (ResourceLocation)IronsSpellbooks.id("whispers_of_ice")))));
    public static final Supplier<DeferredSpawnEggItem> KEEPER_SPAWN_EGG = ITEMS.register("keeper_spawn_egg", () -> new DeferredSpawnEggItem(EntityRegistry.KEEPER, 3484973, 0x766A76, ItemPropertiesHelper.material().stacksTo(64)));
    ...
    public static final Supplier<DeferredSpawnEggItem> ARCHEVOKER_SPAWN_EGG = ITEMS.register("archevoker_spawn_egg", () -> new DeferredSpawnEggItem(EntityRegistry.ARCHEVOKER, 789516, 13412440, ItemPropertiesHelper.material().stacksTo(64)));
    public static final Supplier<DeferredSpawnEggItem> NECROMANCER_SPAWN_EGG = ITEMS.register("necromancer_spawn_egg", () -> new DeferredSpawnEggItem(EntityRegistry.NECROMANCER, 4074272, 5331255, ItemPropertiesHelper.material().stacksTo(64)));
    public static final Supplier<DeferredSpawnEggItem> CRYOMANCER_SPAWN_EGG = ITEMS.register("cryomancer_spawn_egg", () -> new DeferredSpawnEggItem(EntityRegistry.CRYOMANCER, 0xFFFFFF, 9961453, ItemPropertiesHelper.material().stacksTo(64)));
    public static final Supplier<DeferredSpawnEggItem> PYROMANCER_SPAWN_EGG = ITEMS.register("pyromancer_spawn_egg", () -> new DeferredSpawnEggItem(EntityRegistry.PYROMANCER, 7999504, 0x262525, ItemPropertiesHelper.material().stacksTo(64)));
    public static final Supplier<DeferredSpawnEggItem> PRIEST_SPAWN_EGG = ITEMS.register("priest_spawn_egg", () -> new DeferredSpawnEggItem(EntityRegistry.PRIEST, 0xFFFFFF, 16768600, ItemPropertiesHelper.material().stacksTo(64)));
    public static final Supplier<DeferredSpawnEggItem> APOTHECARIST_SPAWN_EGG = ITEMS.register("apothecarist_spawn_egg", () -> new DeferredSpawnEggItem(EntityRegistry.APOTHECARIST, 3626026, 13931127, ItemPropertiesHelper.material().stacksTo(64)));
    public static final Supplier<DeferredSpawnEggItem> ICE_SPIDER_SPAWN_EGG = ITEMS.register("ice_spider_spawn_egg", () -> new DeferredSpawnEggItem(EntityRegistry.ICE_SPIDER, 8552850, 16119275, ItemPropertiesHelper.material().stacksTo(64)));
