...
public class ClientConfigs {
    ...
    public static final ModConfigSpec.ConfigValue<ManaBarOverlay.Display> SPELL_BAR_DISPLAY;
    ...
    static {
        ...
        MANA_BAR_DISPLAY = BUILDER.defineEnum("manaBarDisplay", (Enum)ManaBarOverlay.Display.Contextual);
        BUILDER.comment("Used to adjust mana bar's position (11 is one full hunger bar up).");
        MANA_BAR_X_OFFSET = BUILDER.define("manaBarXOffset", (Object)0);
        MANA_BAR_Y_OFFSET = BUILDER.define("manaBarYOffset", (Object)0);
        MANA_BAR_TEXT_VISIBLE = BUILDER.define("manaBarTextVisible", true);
        MANA_BAR_ANCHOR = BUILDER.defineEnum("manaBarAnchor", (Enum)ManaBarOverlay.Anchor.Hunger);
        MANA_TEXT_X_OFFSET = BUILDER.define("manaTextXOffset", (Object)0);
        MANA_TEXT_Y_OFFSET = BUILDER.define("manaTextYOffset", (Object)0);
        BUILDER.pop();
        ...
        SPELL_BAR_DISPLAY = BUILDER.defineEnum("spellBarDisplay", (Enum)ManaBarOverlay.Display.Always);
        BUILDER.comment("Used to adjust spell bar's position.");
        SPELL_BAR_X_OFFSET = BUILDER.define("spellBarXOffset", (Object)0);
        SPELL_BAR_Y_OFFSET = BUILDER.define("spellBarYOffset", (Object)0);
        SPELL_BAR_ANCHOR = BUILDER.defineEnum("spellBarAnchor", (Enum)SpellBarOverlay.Anchor.Hotbar);
        BUILDER.pop();
        BUILDER.push("RecastOverlay");
        RECAST_ANCHOR = BUILDER.defineEnum("recastAnchor", (Enum)RecastOverlay.Anchor.TopCenter);
        RECAST_X_OFFSET = BUILDER.define("recastXOffset", (Object)0);
        RECAST_Y_OFFSET = BUILDER.define("recastYOffset", (Object)0);
        BUILDER.pop();
        ...
        SPELL_WHEEL_SCALE = BUILDER.comment("If ignoreGuiScale is enabled, apply this multiplier to its size").define("ignoreGuiScaleSizeMultiplier", (Object)1.0);
        BUILDER.pop();
        BUILDER.pop();
        ...
        BUILDER.pop();
        BUILDER.push("Misc");
        SHIELD_PARTICLE_COLLISIONS = BUILDER.comment("Whether shield spells can collide with particles. Can affect performance. Default: true").define("shieldParticleCollisions", true);
        BUILDER.pop();
        BUILDER.push("Summons");
        SUMMONS_GLOW = BUILDER.comment("Whether owned summons appear glowing to yourself. Default: true").define("ownedSummonsGlow", true);
        SUMMONS_GLOW_HEX_COLOR = BUILDER.comment("Hex Color Value of owned summons glow outline. Default: 0xAAFFAA").define("summonGlowColor", (Object)"0xAAFFAA");
        BUILDER.pop();
        SPEC = BUILDER.build();
    }
}
