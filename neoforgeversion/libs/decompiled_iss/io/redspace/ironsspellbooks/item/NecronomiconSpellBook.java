...
public class NecronomiconSpellBook
extends UniqueSpellBook {
    public NecronomiconSpellBook() {
        ...
        this.withSpellbookAttributes(new AttributeContainer((Holder<Attribute>)AttributeRegistry.MAX_MANA, 200.0, AttributeModifier.Operation.ADD_VALUE));
    }
