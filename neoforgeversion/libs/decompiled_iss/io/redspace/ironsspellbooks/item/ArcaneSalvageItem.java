...
public class ArcaneSalvageItem
extends Item {
    private static final Component description = Component.translatable((String)"item.irons_spellbooks.arcane_salvage_desc").withStyle(ChatFormatting.GRAY);
