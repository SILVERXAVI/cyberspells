...
public class CryomancerArmorItem
extends ImbuableChestplateArmorItem {
    public CryomancerArmorItem(ArmorItem.Type slot, Item.Properties settings) {
        super((Holder<ArmorMaterial>)ArmorMaterialRegistry.SCHOOL, slot, settings, CryomancerArmorItem.schoolAttributes(AttributeRegistry.ICE_SPELL_POWER));
    }
