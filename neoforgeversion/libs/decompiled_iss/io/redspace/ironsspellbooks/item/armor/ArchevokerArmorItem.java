...
public class ArchevokerArmorItem
extends ImbuableChestplateArmorItem {
    public ArchevokerArmorItem(ArmorItem.Type type, Item.Properties settings) {
        super((Holder<ArmorMaterial>)ArmorMaterialRegistry.SCHOOL, type, settings, ArchevokerArmorItem.schoolAttributes(AttributeRegistry.EVOCATION_SPELL_POWER));
    }
