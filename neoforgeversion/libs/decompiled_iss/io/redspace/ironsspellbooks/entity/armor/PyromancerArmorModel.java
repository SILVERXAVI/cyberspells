...
public class PyromancerArmorModel
extends GeoModel<PyromancerArmorItem> {
    public ResourceLocation getModelResource(PyromancerArmorItem object) {
        return ResourceLocation.fromNamespaceAndPath((String)"irons_spellbooks", (String)"geo/pyromancer_armor.geo.json");
    }

    public ResourceLocation getTextureResource(PyromancerArmorItem object) {
        return ResourceLocation.fromNamespaceAndPath((String)"irons_spellbooks", (String)"textures/models/armor/pyromancer.png");
    }
