...
public class SummonedSkeleton
extends Skeleton
implements IMagicSummon,
GeoAnimatable {
    private static final EntityDataAccessor<Boolean> DATA_IS_ANIMATING_RISE = SynchedEntityData.defineId(SummonedSkeleton.class, (EntityDataSerializer)EntityDataSerializers.BOOLEAN);
    ...
    public SummonedSkeleton(Level level, LivingEntity owner, boolean playRiseAnimation) {
        this((EntityType<? extends Skeleton>)((EntityType)EntityRegistry.SUMMONED_SKELETON.get()), level);
