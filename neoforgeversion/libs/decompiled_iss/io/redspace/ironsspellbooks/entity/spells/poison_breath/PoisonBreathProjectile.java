...
public class PoisonBreathProjectile
extends AbstractConeProjectile {
    ...
    public PoisonBreathProjectile(Level level, LivingEntity entity) {
        super((EntityType<? extends AbstractConeProjectile>)((EntityType)EntityRegistry.POISON_BREATH_PROJECTILE.get()), level, entity);
    }
    ...
    public void spawnParticles() {
        ...
        for (int i = 0; i < 20; ++i) {
            ...
            this.level().addParticle(this.random.nextFloat() < 0.25f ? ParticleHelper.ACID_BUBBLE : ParticleHelper.ACID, x + ox, y + oy, z + oz, result.x, result.y, result.z);
        }
    }
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if (DamageSources.applyDamage(entity, this.damage, SpellRegistry.POISON_BREATH_SPELL.get().getDamageSource((Entity)this, this.getOwner())) && entity instanceof LivingEntity) {
