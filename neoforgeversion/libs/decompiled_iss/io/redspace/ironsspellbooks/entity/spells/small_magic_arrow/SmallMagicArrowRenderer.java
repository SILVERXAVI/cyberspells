...
public class SmallMagicArrowRenderer
extends EntityRenderer<SmallMagicArrow> {
    ...
    public void render(SmallMagicArrow entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        ...
        SmallMagicArrowRenderer.renderModel(poseStack, bufferSource);
        poseStack.popPose();
    ...
    public static void renderModel(PoseStack poseStack, MultiBufferSource bufferSource) {
        ...
        VertexConsumer consumer = bufferSource.getBuffer(RenderHelper.CustomerRenderType.magic(SmallMagicArrowRenderer.getTextureLocation()));
        poseStack.mulPose(Axis.YP.rotationDegrees(90.0f));
        poseStack.translate(-2.0f, 0.0f, 0.0f);
        for (int j = 0; j < 4; ++j) {
            poseStack.mulPose(Axis.XP.rotationDegrees(90.0f));
            SmallMagicArrowRenderer.vertex(poseMatrix, normalMatrix, consumer, -8, -2, 0, 0.0f, 0.0f, 0, 1, 0, 0xF000F0);
            SmallMagicArrowRenderer.vertex(poseMatrix, normalMatrix, consumer, 8, -2, 0, 0.5f, 0.0f, 0, 1, 0, 0xF000F0);
            SmallMagicArrowRenderer.vertex(poseMatrix, normalMatrix, consumer, 8, 2, 0, 0.5f, 0.15625f, 0, 1, 0, 0xF000F0);
            SmallMagicArrowRenderer.vertex(poseMatrix, normalMatrix, consumer, -8, 2, 0, 0.0f, 0.15625f, 0, 1, 0, 0xF000F0);
        }
    }
    ...
    public ResourceLocation getTextureLocation(SmallMagicArrow entity) {
        return SmallMagicArrowRenderer.getTextureLocation();
    }
