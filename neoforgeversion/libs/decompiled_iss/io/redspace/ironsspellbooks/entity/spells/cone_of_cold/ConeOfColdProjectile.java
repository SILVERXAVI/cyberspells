...
public class ConeOfColdProjectile
extends AbstractConeProjectile {
    ...
    public ConeOfColdProjectile(Level level, LivingEntity entity) {
        super((EntityType<? extends AbstractConeProjectile>)((EntityType)EntityRegistry.CONE_OF_COLD_PROJECTILE.get()), level, entity);
    }
    ...
    public void spawnParticles() {
        ...
        double z = pos.z;
        for (int i = 0; i < 10; ++i) {
            double speed = this.random.nextDouble() * 0.7 + 0.15;
            double offset = 0.125;
            ...
            this.level.addParticle(Math.random() > 0.15 ? ParticleHelper.SNOW_DUST : ParticleHelper.SNOWFLAKE, x + ox, y + oy, z + oz, result.x, result.y, result.z);
        }
    }
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        DamageSources.applyDamage(entity, this.damage, SpellRegistry.CONE_OF_COLD_SPELL.get().getDamageSource((Entity)this, this.getOwner()));
    }
}
