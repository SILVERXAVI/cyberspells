...
public class ReplacedFireballRenderer
extends FireballRenderer {
    ...
    public void render(Projectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        if (entity instanceof LargeFireball && ((Boolean)ClientConfigs.REPLACE_GHAST_FIREBALL.get()).booleanValue() || entity instanceof SmallFireball && ((Boolean)ClientConfigs.REPLACE_BLAZE_FIREBALL.get()).booleanValue()) {
            super.render(entity, yaw, partialTicks, poseStack, bufferSource, light);
        } else {
            this.backupRenderer.render((Entity)((Fireball)entity), yaw, partialTicks, poseStack, bufferSource, light);
        }
    }
}
