...
public final class CyberpsychosisTrigger
extends SimpleCriterionTrigger<Instance> {
    ...
    public record Instance(Optional<ContextAwarePredicate> player) implements SimpleCriterionTrigger.SimpleInstance
    {
        ...
        public static Criterion<Instance> any() {
            return ((CyberpsychosisTrigger)((Object)ModCriteria.CYBERPSYCHOSIS.get())).createCriterion((CriterionTriggerInstance)new Instance(Optional.empty()));
        }
    }
}
