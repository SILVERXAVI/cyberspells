...
public final class DavidMartinezSpecialTrigger
extends SimpleCriterionTrigger<Instance> {
    ...
    public record Instance(Optional<ContextAwarePredicate> player) implements SimpleCriterionTrigger.SimpleInstance
    {
        ...
        public static Criterion<Instance> any() {
            return ((DavidMartinezSpecialTrigger)((Object)ModCriteria.DAVID_SPECIAL.get())).createCriterion((CriterionTriggerInstance)new Instance(Optional.empty()));
        }
    }
}
