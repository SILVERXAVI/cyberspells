...
public final class FirstRipperdocVisitTrigger
extends SimpleCriterionTrigger<Instance> {
    ...
    public record Instance(Optional<ContextAwarePredicate> player) implements SimpleCriterionTrigger.SimpleInstance
    {
        ...
        public static Criterion<Instance> any() {
            return ((FirstRipperdocVisitTrigger)((Object)ModCriteria.FIRST_RIPPERDOC_VISIT.get())).createCriterion((CriterionTriggerInstance)new Instance(Optional.empty()));
        }
    }
}
