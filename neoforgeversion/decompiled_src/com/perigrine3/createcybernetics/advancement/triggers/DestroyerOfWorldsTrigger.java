...
public final class DestroyerOfWorldsTrigger
extends SimpleCriterionTrigger<Instance> {
    ...
    public record Instance(Optional<ContextAwarePredicate> player) implements SimpleCriterionTrigger.SimpleInstance
    {
        ...
        public static Criterion<Instance> any() {
            return ((DestroyerOfWorldsTrigger)((Object)ModCriteria.DESTROYER_OF_WORLDS.get())).createCriterion((CriterionTriggerInstance)new Instance(Optional.empty()));
        }
    }
}
