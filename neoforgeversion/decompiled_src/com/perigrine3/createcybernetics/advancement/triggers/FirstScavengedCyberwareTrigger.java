...
public final class FirstScavengedCyberwareTrigger
extends SimpleCriterionTrigger<Instance> {
    ...
    public record Instance(Optional<ContextAwarePredicate> player) implements SimpleCriterionTrigger.SimpleInstance
    {
        ...
        public static Criterion<Instance> any() {
            return ((FirstScavengedCyberwareTrigger)((Object)ModCriteria.FIRST_SCAVENGED_CYBERWARE.get())).createCriterion((CriterionTriggerInstance)new Instance(Optional.empty()));
        }
    }
}
