...
implements ICyberwareItem {
    ...
    public MarrowBatteryItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add((Component)Component.translatable((String)"tooltip.createcybernetics.boneupgrades_bonebattery.energy").withStyle(ChatFormatting.DARK_PURPLE));
        }
    }
