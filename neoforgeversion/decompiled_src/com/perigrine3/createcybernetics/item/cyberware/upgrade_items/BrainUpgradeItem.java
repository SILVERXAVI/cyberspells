...
public class BrainUpgradeItem
extends Item
implements ICyberwareItem {
    private final int humanityCost;

    public BrainUpgradeItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public void onTick(Player player) {
        ...
        if (ModItems.BRAINUPGRADES_CONSCIOUSNESSTRANSMITTER == null || ModItems.BRAINUPGRADES_CORTICALSTACK == null || ModList.get().isLoaded("createenchantmentindustry")) {
            // empty if block
        }
