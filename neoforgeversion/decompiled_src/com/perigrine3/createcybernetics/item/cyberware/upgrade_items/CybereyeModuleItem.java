...
public class CybereyeModuleItem
extends Item
implements ICyberwareItem {
    ...
    public CybereyeModuleItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public void onTick(Player player) {
        ...
        if (ModItems.EYEUPGRADES_NAVIGATIONCHIP == null || ModList.get().isLoaded("xaerominimap")) {
            // empty if block
        }
