...
public class HUDlensItem
extends Item
implements ICyberwareItem {
    private final int humanityCost;

    public HUDlensItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add((Component)Component.translatable((String)"tooltip.createcybernetics.eyeupgrades_hudlens.energy").withStyle(ChatFormatting.RED));
        }
    }
    ...
    public Set<Item> requiresCyberware(ItemStack installedStack, CyberwareSlot slot) {
        return Set.of((Item)ModItems.BODYPART_EYEBALLS.get());
    }
