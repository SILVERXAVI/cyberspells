...
public class EyeOfDefenderItem
extends Item
implements ICyberwareItem {
    ...
    public EyeOfDefenderItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add((Component)Component.translatable((String)"tooltip.createcybernetics.brainupgrades_eyeofdefender.energy").withStyle(ChatFormatting.RED));
        }
    }
    ...
    private static boolean isActive(Player player) {
        ...
        PlayerCyberwareData data = (PlayerCyberwareData)p.getData(ModAttachments.CYBERWARE);
        if (data == null) {
            return false;
        }
        ...
        for (int idx = 0; idx < arr.length; ++idx) {
            ...
            if (cw == null || (st = cw.getItem()) == null || st.isEmpty() || !(st.getItem() instanceof EyeOfDefenderItem)) continue;
    ...
    public static final class Events {
        ...
        public static void onPlayerTick(PlayerTickEvent.Post event) {
            ...
            if (EyeOfDefenderItem.isActive(player)) {
                player.addEffect(new MobEffectInstance(ModEffects.PROJECTILE_DODGE_EFFECT, 40, 0, false, false, false));
