...
public class TargetingModuleItem
extends Item
implements ICyberwareItem {
    private final int humanityCost;

    public TargetingModuleItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add((Component)Component.translatable((String)"tooltip.createcybernetics.eyeupgrades_targeting.energy").withStyle(ChatFormatting.RED));
        }
    }
