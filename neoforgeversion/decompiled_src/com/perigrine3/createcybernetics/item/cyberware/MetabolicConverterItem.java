...
public class MetabolicConverterItem
extends Item
implements ICyberwareItem {
    ...
    public MetabolicConverterItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add((Component)Component.translatable((String)"tooltip.createcybernetics.organsupgrades_metabolic.energy").withStyle(ChatFormatting.DARK_GREEN));
        }
    }

    @Override
    public int getEnergyGeneratedPerTick(Player player, ItemStack installedStack, CyberwareSlot slot) {
        return player.getFoodData().getFoodLevel() > 0 ? 25 : 0;
    }
    ...
    public void onTick(Player player) {
        ...
        if (!data.hasSpecificItem(this, CyberwareSlot.ORGANS)) {
            return;
        }
