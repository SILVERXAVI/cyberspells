...
public class IsothermalSkinItem
extends Item
implements ICyberwareItem {
    private final int humanityCost;
    private boolean isInstalled = false;

    public IsothermalSkinItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public void onInstalled(Player player) {
        CyberwareAttributeHelper.applyModifier((LivingEntity)player, "isothermal_burning");
    }

    @Override
    public void onRemoved(Player player) {
        CyberwareAttributeHelper.removeModifier((LivingEntity)player, "isothermal_burning");
    }
