...
public class SpursItem
extends Item
implements ICyberwareItem {
    private final int humanityCost;

    public SpursItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public Set<TagKey<Item>> requiresCyberwareTags(ItemStack installedStack, CyberwareSlot slot) {
        return switch (slot) {
            case CyberwareSlot.RLEG -> Set.of(ModTags.Items.RIGHTLEG_ITEMS);
            case CyberwareSlot.LLEG -> Set.of(ModTags.Items.LEFTLEG_ITEMS);
            default -> Set.of();
        };
    }
