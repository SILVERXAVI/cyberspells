...
public class NavigationChipItem
extends Item
implements ICyberwareItem {
    private final int humanityCost;

    public NavigationChipItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add((Component)Component.translatable((String)"tooltip.createcybernetics.eyeupgrades_navigationchip.energy").withStyle(ChatFormatting.RED));
        }
    }
