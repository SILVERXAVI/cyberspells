...
public class SpellJammerItem
extends Item
implements ICyberwareItem {
    private final int humanityCost;

    public SpellJammerItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public void onTick(Player player) {
        ...
        List targets = player.level().getEntitiesOfClass(LivingEntity.class, aabb, LivingEntity::isAlive);
