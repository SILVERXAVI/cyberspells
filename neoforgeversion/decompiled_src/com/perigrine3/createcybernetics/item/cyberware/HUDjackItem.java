...
implements ICyberwareItem {
    ...
    public HUDjackItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add((Component)Component.translatable((String)"tooltip.createcybernetics.eyeupgrades_hudjack.energy").withStyle(ChatFormatting.RED));
        }
    }
