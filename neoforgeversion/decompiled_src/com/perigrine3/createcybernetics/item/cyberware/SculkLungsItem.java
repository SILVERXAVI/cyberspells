...
public class SculkLungsItem
extends Item
implements ICyberwareItem {
    private final int humanityCost;

    public SculkLungsItem(Item.Properties props, int humanityCost) {
        super(props);
    ...
    public Set<Item> incompatibleCyberware(ItemStack installedStack, CyberwareSlot slot) {
        return Set.of((Item)ModItems.WETWARE_AEROSTASISGYROBLADDER.get(), (Item)ModItems.BODYPART_LUNGS.get());
    }
