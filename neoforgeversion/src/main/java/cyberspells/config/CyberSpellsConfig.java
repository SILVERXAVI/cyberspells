...
public class CyberSpellsConfig {
        ...
        public static final ModConfigSpec.DoubleValue FIRE_RUNE_POWER;
        public static final ModConfigSpec.DoubleValue FIRE_RUNE_RESIST;
        public static final ModConfigSpec.DoubleValue ICE_RUNE_POWER;
        public static final ModConfigSpec.DoubleValue ICE_RUNE_RESIST;
        public static final ModConfigSpec.DoubleValue LIGHTNING_RUNE_POWER;
        public static final ModConfigSpec.DoubleValue LIGHTNING_RUNE_RESIST;
        public static final ModConfigSpec.DoubleValue HOLY_RUNE_POWER;
        public static final ModConfigSpec.DoubleValue HOLY_RUNE_RESIST;
        public static final ModConfigSpec.DoubleValue ENDER_RUNE_POWER;
        public static final ModConfigSpec.DoubleValue ENDER_RUNE_RESIST;
        public static final ModConfigSpec.DoubleValue BLOOD_RUNE_POWER;
        public static final ModConfigSpec.DoubleValue BLOOD_RUNE_RESIST;
        public static final ModConfigSpec.DoubleValue EVOCATION_RUNE_POWER;
        public static final ModConfigSpec.DoubleValue EVOCATION_RUNE_RESIST;
        public static final ModConfigSpec.DoubleValue NATURE_RUNE_POWER;
        public static final ModConfigSpec.DoubleValue NATURE_RUNE_RESIST;

        public static final ModConfigSpec.DoubleValue ARCANE_RUNE_MANA;
        public static final ModConfigSpec.DoubleValue ARCANE_RUNE_REGEN;
        public static final ModConfigSpec.DoubleValue COOLDOWN_RUNE_CDR;
        public static final ModConfigSpec.DoubleValue COOLDOWN_RUNE_CAST;
        public static final ModConfigSpec.DoubleValue PROTECTION_RUNE_RESIST;
        public static final ModConfigSpec.DoubleValue PROTECTION_RUNE_POWER;
        public static final ModConfigSpec.DoubleValue BLANK_RUNE_POWER;
        public static final ModConfigSpec.DoubleValue BLANK_RUNE_RESIST;

        public static final ModConfigSpec.IntValue ARM_SLOTS;
        public static final ModConfigSpec.IntValue LEG_SLOTS;
        public static final ModConfigSpec.IntValue HEART_SLOTS;

        public static final ModConfigSpec.DoubleValue ARM_ESSENCE;
        public static final ModConfigSpec.DoubleValue LEG_ESSENCE;
        public static final ModConfigSpec.DoubleValue HEART_ESSENCE;
        ...
        static {
                ...
                HEART_ESSENCE = BUILDER.comment("Essence cost for Cybernetic Rune Heart")
                                .defineInRange("heart_essence_cost", 10.0, 0.0, 100.0);
                BUILDER.pop();
