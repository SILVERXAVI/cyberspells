...
public class CyberRuneLegItem extends CyberlegItem implements RuneHolder, ICyberware {
    ...
    public int getSlot(ItemStack stack) {
        // LEGS slot start index is 16 * 9 = 144
        return 144;
    }
    ...
    public BodyPartType getBodyPartType(ItemStack stack) {
        return partName.contains("left") ? BodyPartType.LEG_LEFT : BodyPartType.LEG_RIGHT;
    }
